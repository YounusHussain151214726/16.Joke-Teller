...
function test(getJoke) {
  VoiceRSS.speech({
    key: "be4720dcc9a0407494595ed0348005ed",
    src: getJoke,
    hl: "en-us",
    v: "Linda",
    r: 0,
...
const apiUrl = `https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,racist,sexist,explicit&idRange=1-200`;
